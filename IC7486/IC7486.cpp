/*
IC7486.cpp - Library to test the integrated circuit 7486 (Quad 2 inputs XOR gates)
...
IC7486::IC7486(int _inputs[4][2], int _outputs[4])
{
...
boolean IC7486::checkGate(int inputs[2], int output)
{
  for(int i=0;i<4;i++)
  {
