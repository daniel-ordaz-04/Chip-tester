/*
IC7402.cpp - Library to test the integrated circuit 7402 (Quad 2 inputs NOR gates)
...
IC7402::IC7402(int _inputs[4][2], int _outputs[4])
{
...
boolean IC7402::checkGate(int inputs[2], int output)
{
  for(int i=0;i<4;i++)
  {
