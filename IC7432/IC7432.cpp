/*
IC7432.cpp - Library to test the integrated circuit 7432 (Quad 2 inputs OR gates)
...
IC7432::IC7432(int _inputs[4][2], int _outputs[4])
{
...
boolean IC7432::checkGate(int inputs[2], int output)
{
  for(int i=0;i<4;i++)
  {
